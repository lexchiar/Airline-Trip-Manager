...
export default function ServerSettings(props) {
    const [serverInput, setServerInput, config, validServer, resetModal]
        = useServerInputValidation(props.serverSettings.serverUrl, props.toggleServerSettings);
    ...
    return (
        <Modal isOpen={props.showServerSettings} toggle={closeModalWithoutSaving}>
